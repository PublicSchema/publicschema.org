...
const en = {
  ...
  'vocab_detail.external_values_note': 'This vocabulary is defined by an external standard. The full list of values is available in the downloads above.',
  ...
  'vocab_detail.same_standard_desc': 'The following systems use the same underlying standard for this vocabulary, so values are directly compatible without mapping:',
