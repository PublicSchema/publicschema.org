...
La recopilación y la puntuación de datos son pasos distintos, con actores, marcas de tiempo y pistas de auditoría diferentes. Los subtipos de Profile registran las respuestas estructuradas de una aplicación única de instrumento y también pueden llevar resultados derivados de aplicar la regla de puntuación canónica del instrumento (por ejemplo, z-scores y bandas de estado en AnthropometricProfile, el grupo de consumo FCS en FoodSecurityProfile, o el identificador de discapacidad WG-SS en FunctioningProfile). ScoringEvent registra el acto de aplicar una regla no estándar, un umbral alternativo o recalcular un puntaje tras una revisión de regla. Esta separación permite a los sistemas recalcular puntajes sin re-recopilar datos, manteniendo los resultados canónicos cerca de las observaciones que los produjeron. Consulte [ADR-006](../decisions/006-profile-hierarchy.md) y [ADR-010](../decisions/010-profile-derived-outputs.md).
