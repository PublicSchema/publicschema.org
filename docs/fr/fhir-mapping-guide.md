...
- [Intégration de registres en FHIR R5 natif](/fr/docs/fhir-registry-integration/) : définitions de médicaments et répertoires de soins, distincts des correspondances R4 du fonctionnement présentées ici.
